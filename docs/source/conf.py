# -*- coding: utf-8 -*-
#
# RPyMostat-sensor documentation build configuration file, created by
...
if is_rtd:
    ...
    htmlhelp_basename = 'RPyMostat-sensordoc'
...
latex_documents = [
  (master_doc, 'RPyMostat-sensor.tex', u'RPyMostat-sensor Documentation',
...
man_pages = [
    (master_doc, 'RPyMostat-sensor', u'RPyMostat-sensor Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'RPyMostat-sensor', u'RPyMostat-sensor Documentation',
   author, 'RPyMostat-sensor', 'One line description of project.',
   'Miscellaneous'),
]
